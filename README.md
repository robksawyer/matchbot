...
You can start matchbot locally by running:
...
Then you can interact with matchbot by typing `matchbot help`.

    matchbot> matchbot help

    matchbot> animate me <query> - The same thing as `image me`, except adds a few
